...
const _page14 = () => import("./chunks/newsletter_5a4a9858.mjs");
const pageMap = new Map([
  ["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
  ["src/pages/index.astro", _page1],
  ["src/pages/newsletter/failure.astro", _page2],
  ["src/pages/newsletter/success.astro", _page3],
  ["src/pages/category/[slug].astro", _page4],
  ["src/pages/rss.xml.ts", _page5],
  ["src/pages/author/[slug].astro", _page6],
  ["src/pages/logout.astro", _page7],
  ["src/pages/signup.astro", _page8],
  ["src/pages/login.astro", _page9],
  ["src/pages/blog/[slug].astro", _page10],
  ["src/pages/blog.astro", _page11],
  ["src/pages/test.astro", _page12],
  ["src/pages/404.astro", _page13],
  ["src/pages/api/newsletter.ts", _page14],
]);
