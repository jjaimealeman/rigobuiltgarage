...
const frontmatter = {
  ...
  date: "08/10/2021",
  featured: false,
  image: "./images/resized/studio.jpg",
  title: "Making a home studio",
  description:
    "A beginner's guide to setting up a home recording studio, including equipment recommendations and tips for optimizing your space.",
};
const file =
...
function getHeadings() {
  return [
    ...
    { depth: 2, slug: "benefits", text: "Benefits" },
    { depth: 2, slug: "challenges", text: "Challenges" },
