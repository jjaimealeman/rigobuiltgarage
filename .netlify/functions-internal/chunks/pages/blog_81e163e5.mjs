...
</p><div class="mb-12">${renderComponent(
                $$result3,
                "CategoryList",
                $$CategoryList,
                { categories: categories, title: "Tags" },
              )}${renderComponent($$result3, "Pagination", $$Pagination, {
                page: page,
                numberOfPosts: allPosts.length,
              })}</div>${renderComponent($$result3, "PostList", $$PostList, {
                posts: posts,
              })}<div class="mb-36">${renderComponent(
                $$result3,
                "Pagination",
                $$Pagination,
                { page: page, numberOfPosts: allPosts.length },
              )}</div>`,
            },
          )}`,
      },
