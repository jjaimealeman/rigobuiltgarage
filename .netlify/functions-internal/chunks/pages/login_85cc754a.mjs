...
import "clsx";
import { X as XataClient, $ as $$H1 } from "./_slug__346ce338.mjs";
...
const $$Login = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      "Layout",
      $$Layout,
      { title: "Log In", description: "Log in page" },
      {
        default: ($$result2) =>
          renderTemplate`${renderComponent(
            ...
            {},
            {
              default: ($$result3) => renderTemplate`${renderComponent(
                ...
                $$H1,
                { text: "Log In" },
              )}${maybeRenderHead()}<form method="POST"><label class="mb-2 block text-teal-900" for="email">Email:</label><input class="border-teal-900 border w-full mb-2 rounded-lg px-6 py-3" type="text" id="email" name="email"><p class="text-red-800 mb-10 h-10">${
                errors.email
              }</p><label class="mb-2 block text-teal-900" for="password">Password:</label><input class="border-teal-900 border w-full mb-2 rounded-lg px-6 py-3" type="password" id="password" name="password"><p class="text-red-800 mb-10 h-10">${
                errors.password
              }</p><button type="submit" class="text-white text-2xl bg-teal-900 w-full rounded-lg px-6 py-3 mb-11">Log In!</button></form><p class="block mt-16">
