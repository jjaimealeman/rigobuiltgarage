...
const $$Image = createComponent(
  ...
  "/home/jaime/www/astrocourse.dev/astrocourse-demo/node_modules/astro/components/Image.astro",
  void 0,
);
  ...
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<picture${spreadAttributes(
      ...
      return renderTemplate`<source${addAttribute(
        srcsetAttribute,
        "srcset",
      )}${addAttribute("image/" + image.options.format, "type")}>`;
    })}<img${addAttribute(fallbackImage.src, "src")}${spreadAttributes(
      additionalAttributes,
    )}${spreadAttributes(fallbackImage.attributes)}></picture>`;
  },
  "/home/jaime/www/astrocourse.dev/astrocourse-demo/node_modules/astro/components/Picture.astro",
  void 0,
);
...
const $$Main = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    Astro2.self = $$Main;
    return renderTemplate`${maybeRenderHead()}<main class="px-24 max-sm:px-5 max-w-7xl mx-auto w-full mb-32">${renderSlot(
      $$result,
      $$slots["default"],
    )}</main>`;
  },
  "/home/jaime/www/astrocourse.dev/astrocourse-demo/src/components/Main.astro",
  void 0,
);
...
Subscribe
  ...
  "/home/jaime/www/astrocourse.dev/astrocourse-demo/src/components/Newsletter.astro",
  void 0,
);
...
const $$Footer = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    Astro2.self = $$Footer;
    return renderTemplate`${maybeRenderHead()}<footer class="bg-green-950 text-center pt-20 pb-6 px-5 max-sm:pb-3 max-sm:pt-8">${renderComponent(
      $$result,
      "Newsletter",
      $$Newsletter,
      {},
    )}<p class="text-zinc-300">Copyright 2023. Rhythm Nation</p></footer>`;
  },
  "/home/jaime/www/astrocourse.dev/astrocourse-demo/src/components/Footer.astro",
  void 0,
);

const heartbeat = {
  src: "/_astro/heartbeat.913af530.png",
  width: 512,
  height: 512,
  format: "png",
};
...
const $$Header = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<header class="flex justify-between items-center px-24 py-12 max-sm:px-5 max-sm:py-10 max-w-7xl w-full mx-auto"><a class="flex items-center gap-x-4" href="/">${renderComponent(
      $$result,
      "Image",
      $$Image,
      { class: "w-16", src: heartbeat, width: 96, height: 96, alt: "logo" },
    )}<p class="uppercase text-3xl text-zinc-900">Blog</p></a>${
      userEmail?.value
        ? renderTemplate`<a href="/logout" class="bg-teal-900 text-white py-3 px-6 rounded-xl text-xl">
Logout
</a>`
        : renderTemplate`<a href="/login" class="bg-teal-900 text-white py-3 px-6 rounded-xl text-xl">
Login
</a>`
    }</header>`;
  },
  "/home/jaime/www/astrocourse.dev/astrocourse-demo/src/components/Header.astro",
  void 0,
);
...
const $$Layout = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`<html lang="en" class="scroll-smooth"><head><meta charset="UTF-8"><meta name="description"${addAttribute(
      description,
      "content",
    )}><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(
      Astro2.generator,
      "content",
    )}><title>${title}</title><!-- Open Graph / Facebook --><meta property="og:type" content="website"><meta property="og:url"${addAttribute(
      Astro2.url,
      "content",
    )}><meta property="og:title"${addAttribute(
      title,
      "content",
    )}><meta property="og:description"${addAttribute(
      description,
      "content",
    )}><meta property="og:image"${addAttribute(
      image,
      "content",
    )}><meta property="og:image:alt"${addAttribute(
      description,
      "content",
    )}><!-- Open Graph / Twitter --><meta property="twitter:card" content="summary_big_image"><meta property="twitter:url"${addAttribute(
      Astro2.url,
      "content",
    )}><meta property="twitter:title"${addAttribute(
      title,
      "content",
    )}><meta property="twitter:description"${addAttribute(
      description,
      "content",
    )}><meta property="twitter:image"${addAttribute(
      image,
      "content",
    )}><meta property="twitter:image:alt"${addAttribute(
      description,
      "content",
    )}>${renderHead()}</head><body class="min-h-screen grid grid-rows-[auto,1fr,auto]">${renderComponent(
      $$result,
      "Header",
      $$Header,
      {},
    )}${renderSlot($$result, $$slots["default"])}${renderComponent(
      $$result,
      "Footer",
      $$Footer,
      {},
  ...
  "/home/jaime/www/astrocourse.dev/astrocourse-demo/src/layouts/Layout.astro",
  void 0,
);
      ...
      { title: "Page Not Found", description: "Page Not Found" },
      {
        default: ($$result2) =>
          renderTemplate`${renderComponent(
            ...
            {
              default: ($$result3) =>
                renderTemplate`${maybeRenderHead()}<h2 class="text-center pt-12 text-2xl">OOPS! Page not Found!</h2>`,
            },
          )}`,
      },
    )}`;
